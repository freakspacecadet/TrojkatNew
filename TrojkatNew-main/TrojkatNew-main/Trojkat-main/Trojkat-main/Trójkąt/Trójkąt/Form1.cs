...
namespace Trójkąt
{
    public partial class Form1 : Form
    {
        ...
        private void paniMichalskaToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            MessageBox.Show("Program liczy wartości funkcji trygonometrycznych w trójkącie prostokątnym z dokładnością do 3 miejsc po przecinku.", "O programie");

        }

        private void oAutorzeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show("(C) A.S. 2023. Więcej się nie dowiesz.", "O autorze");
        }
    }
}
